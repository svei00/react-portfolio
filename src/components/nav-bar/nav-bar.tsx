...
// cues from. Route labels stay the current IA (Home/About/Portfolio/
// Skills/Contact) — the /work rename and the Skills-into-About merge are
// separate sub-phases (3.3 and 3.4) and should not be pulled forward here.
const NAV_LINKS = [
  { href: '/', label: 'Home' },
